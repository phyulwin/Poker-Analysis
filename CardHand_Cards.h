...
class CardHand_Cards: public CardSMFL, CalculateOutput {
private:
...
public:
    ...
    sf::Text royalFlushText, straightFlushText, fourOfAKindText, fullHouseText,
            flushText, straightText, threeOfAKindText, twoPairText, onePairText, highCardText;    void textDisplayForScores();
};
